...
app.use(cors());// Middleware pour gérer les requêtes CORS : ça permet de gérer les requêtes cross-origin, c'est-à-dire les requêtes provenant d'un domaine différent de celui du serveur
